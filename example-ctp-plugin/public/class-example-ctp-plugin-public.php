 ...
 * @subpackage Example_Ctp_Plugin/public
 */
 ...
 */
class Example_Ctp_Plugin_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/example-ctp-plugin-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/example-ctp-plugin-public.js', array( 'jquery' ), $this->version, true );
	 ...
	 *
	 * Shortcode can take attributes like [example-ctp-plugin-shortcode attribute='123']
	 * Shortcodes can be enclosing content [example-ctp-plugin-shortcode attribute='123']custom content[/example-ctp-plugin-shortcode].
	 *
	 ...
	 */
	public function ecp_shortcode_func( $atts, $content = null, $tag ) {
